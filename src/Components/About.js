        ...
        <div id="about" className="about-us">
            <div className="about-us-img">
                <img 
                  ...
                  alt="Daterence Removals team in action, providing expert house removal services" 
                  loading="lazy"
                />
            </div>
